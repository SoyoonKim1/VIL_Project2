...
# EPOCHS=200 BATCH_SIZE=256 SAVE_DIR=... ./scripts/run_swav_mcq_gpu1_nohup.sh
EPOCHS="${EPOCHS:-200}"
BATCH_SIZE="${BATCH_SIZE:-256}"
NUM_WORKERS="${NUM_WORKERS:-8}"
SEED="${SEED:-42}"
SAVE_DIR="${SAVE_DIR:-./outputs/swav_stl10_mcq_gpu1_seed${SEED}}"
LOG_FILE="${LOG_FILE:-./logs/swav_mcq_gpu1_seed${SEED}.log}"
TB_LOG_DIR="${TB_LOG_DIR:-${SAVE_DIR}/tensorboard}"
TB_PORT="${TB_PORT:-6006}"

# SwAV MCQ tuned defaults
...
echo "Launching SwAV-MCQ training with nohup on GPU 1..."
